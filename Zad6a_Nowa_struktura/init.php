...
function &getSmarty(){
    ...
    if (!isset($smarty)){
        ...
        include_once getConf()->root_path.'/core/smarty/Smarty.class.php';
        $smarty = new Smarty();
        //przypisz konfigurację i messages
        $smarty->setTemplateDir(getConf()->root_path.'/app/views/templates');
        $smarty->setCompileDir(getConf()->root_path.'/app/views/templates_c');
